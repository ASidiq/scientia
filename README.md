...
The image above shows the trello board used in managing the tasks completed within this project.

- User stories - refers to features required by the user. Contained within the user stories are tasks required to complete the user story
- Current sprint backlog - contains the user stories scheduled for a sprint. However, the user story is yet to be worked on
- Sprint in progress - refers to user stories currently being worked
- Done - this column has all the completed user stories. Also completed test go into the done section
